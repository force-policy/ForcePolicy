...
scheduler_config = SlowFastSchedulerConfig(
    ...
    action_params = {
        "robot/right/tcp_pose": {
            ...
            "max_angular_vel": 1.0,
            "max_angular_acc": 2.0,
            "max_search_force_vel": [0.05, 0.05, 0.05]
        }
    },
    ...
    fast_sync_action_config = {
        ...
        "robot/right/tcp_wrench": SyncActionConfig(
            source_frequency = 50,
            source_length = 1,
            interpolation = "linear",
        ),
        "robot/right/force_frame": SyncActionConfig(
            source_frequency = 50,
            source_length = 1,
            interpolation = "pose_linear",
            rotation_rep = RotationType.QUATERNION
        ),
        "robot/right/force_frame_mask": SyncActionConfig(
            source_frequency = 50,
            source_length = 1,
