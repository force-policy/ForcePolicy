...
processor_config = DataProcessorConfig(
    obs_data_configs = {
        ...
        "proprio_tcp": PoseConfig(
            src = PoseSourceConfig(
                input_key = "tcp_pose",
                frame = "robot_base/main",
                rotation_rep = RotationType.QUATERNION,
                convention = None
            ),
            frame = "robot_tcp/main/aux_tcp_pose/quaternion",
        ...
        "force_torque": WrenchConfig(
            src = WrenchSourceConfig(
                ...
                frame = "robot_tcp/main/tcp_pose/quaternion"
            ),
            frame = "robot_tcp/main/tcp_pose/quaternion",
            rotation_only = True,
            norm_config = LinearNormalizationConfig(
                min_value = [-250.0, -250.0, -250.0, -10.0, -10.0, -10.0], 
                max_value = [250.0, 250.0, 250.0, 10.0, 10.0, 10.0]
            ),
            aug_groups = []
        )
    },
    ...
    action_data_reverse_configs = {
        "action_tcp": PoseInferenceConfig(
            src_key = "action_tcp",
            src_frame = "robot_tcp/main/aux_tcp_pose/quaternion",
